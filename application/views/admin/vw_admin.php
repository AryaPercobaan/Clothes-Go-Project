<div class="container-fluid my-auto">
    ...
    <div class="row">
        <div class="col-md-6"><a href="<?= base_url(); ?>Admin/tambah" class="btn btn-info mb-2">Tambah Admin</a></div>
				...
				<table class="table table-bordered text-gray-100" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						...
						<?php foreach ($admin as $us) : ?>
							<tr>
								<td> <?= $i; ?>.</td>
								<td><img src="<?= base_url('assets/img/admin/') . $us['gambar']; ?>" style="width:100px" class="img-thumbnail"></td>
								<td><?= $us['nama']; ?></td>
								<td><?= $us['posisi']; ?></td>
								<td><?= $us['shift']; ?></td>
								<td><?= $us['email']; ?></td>
								<td>
									...
									<a href="<?= base_url('Admin/edit/') . $us['id']; ?>" class="badge badge-dark">Edit</a>
								</td>
							</tr>
							<?php $i++; ?>
						<?php endforeach; ?>
