<div class="container-fluid my-auto">
	...
	<div class="clearfix">
		...
		<div class="float-right">
			<a href="<?= base_url('Baju/tambah') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Baju</a>
		</div>
	</div>
				...
				<table class="table table-bordered text-gray-100" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						...
						<?php foreach ($baju as $us) : ?>
							<tr>
								<td> <?= $i; ?>.</td>
								<td><img src="<?= base_url('assets/img/baju1/') . $us['gambar']; ?>" style="width:100px" class="img-thumbnail"></td>
								<td><?= $us['nama']; ?></td>
								...
								<td><?= $us['harga']; ?></td>
								<td>
									<a href="<?= base_url('Baju/hapus/') . $us['id']; ?>" class="badge badge-danger">Hapus</a>
									<a href="<?= base_url('Baju/edit/') . $us['id']; ?>" class="badge badge-dark">Edit</a>
								</td>
							</tr>
							<?php $i++; ?>
						<?php endforeach; ?>
